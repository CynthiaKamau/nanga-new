  ...
  const deleteKPI = async (e) => {
    ...
    try {
      let response = await axios.delete(
        `/kpi/deleteKpiById?kpi_id=${deleteId}`
      );
      if (response.status == 200) {
        setshowloader(false);
        setDeleteOpen(false);
        ...
        return (
          <div>
            ...
            <IconButton
              ...
              style={{ color: "black" }}
              onClick={() => {
                setDeleting(list), handleDeleteClickOpen();
              }}
            >
              <DeleteForever />
            </IconButton>
    ...
    <div style={{ width: "100%" }}>
      <GridContainer>
        <Grid container justify="flex-end" style={{ marginTop: "10px" }}>
          <Button color="primary" size="lg" onClick={handleAddClickOpen}>
            {" "}
            Add KPI{" "}
          </Button>
        </Grid>
        ...
        <GridItem xs={12} sm={12} md={12}>
          ...
          <Dialog open={addopen} onClose={handleAddClose}>
            ...
            <DialogContent>
              <DialogContentText>Create New KPI</DialogContentText>
              <TextField
                autoFocus
                margin="dense"
                id="kpi"
            ...
            <DialogActions>
              <Button color="danger" onClick={handleAddClose}>
                Cancel
              </Button>
              {showloader === true ? (
          ...
          <Dialog open={deleteopen} onClose={handleDeleteClose}>
            ...
            <DialogActions>
              <Button color="danger" onClick={handleDeleteClose}>
                Disagree
              </Button>
              {showloader === true ? (
                <div style={{ textAlign: "center", marginTop: 10 }}>
